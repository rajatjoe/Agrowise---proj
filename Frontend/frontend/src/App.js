...
import './index.css'; import { GiHamburgerMenu } from "react-icons/gi";
import { BrowserRouter as Router, Routes, Route, Link } from "react-router-dom";
import Home from './pages/Home'; import Features from './pages/Features';
import Suggestion from './pages/Suggestion'; import Diseasse from './pages/Diseasse';
import Schemes from './pages/Schemes'; import navlogo from './images/logo.png'
    ...
    <div className='container-page'>
      <Router>
        <header>
          ...
          <div className='logo'>
            <img src={navlogo} style={{ width: "150px" }} alt="logo" />
